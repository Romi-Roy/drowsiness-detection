...
from playsound import playsound  # To play alarm sound
...
class VideoFrameHandler:
    def __init__(self):
        ...
        # Initialize Mediapipe FaceMesh solution pipeline
        self.facemesh_model = get_mediapipe_app()

        # For tracking drowsiness states
        self.state_tracker = {
    ...
    def process(self, frame: np.array, thresholds: dict):
        ...
        ALM_txt_pos = (10, int(frame_h * 0.9))
        ...
        if results.multi_face_landmarks:
            ...
            if EAR < thresholds["EAR_THRESH"]:
                ...
                if self.state_tracker["DROWSY_TIME"] >= thresholds["WAIT_TIME"]:
                    ...
                    plot_text(frame, "WAKE UP!", ALM_txt_pos, self.state_tracker["COLOR"])
...
if __name__ == "__main__":
    try:
        video_path = 'video_inputs/video_002.mp4'  # Set the path to your video file
        ...
        delay = int(1000 / fps)  # Calculate the delay between frames in milliseconds

        video_handler = VideoFrameHandler()
        thresholds = {
            "EAR_THRESH": 0.18,
            "WAIT_TIME": 1.0  # Example wait time
        }
        ...
        while cap.isOpened():
            ...
            if play_alarm:
                playsound('alarm.mp3', block=False)  # Play alarm sound if drowsy

            # Wait for the delay calculated from the frame rate
